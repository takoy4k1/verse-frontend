...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center  justify-center min-h-[70vh] text-center px-4">
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-3xl text-left border-t border-white-200 dark:border-white-800 pt-12 text-white">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-white-200 text-sm">Share brief updates and start conversations with your followers.</p>
        </div>
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-white-200 text-sm">Like comments and interact with posts that resonate with you.</p>
        </div>
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-white-200 text-sm">Find friends, follow interesting people, and build your network.</p>
        </div>
      </div>
    </div>
  );
